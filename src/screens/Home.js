          ...
          <div className="adminPopUp">
            {!authSuccess ? (
              ...
              <>
                ...
                {<textarea className="SummmaryInput" value={projectSummary} onChange={(e)=> setProjectSummary(e.target.value)} placeholder='Project Summary'/>}
                {<input value={gitHubLink} onChange={(e)=> setGitHubLink(e.target.value)} placeholder='Git Hub Link'/>}
